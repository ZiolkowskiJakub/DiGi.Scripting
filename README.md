...
**DiGi.Scripting** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Scripting.CSharp](DiGi.Scripting.CSharp)** (Path: `DiGi.Scripting\DiGi.Scripting.CSharp`)
* **[DiGi.Scripting.Python](DiGi.Scripting.Python)** (Path: `DiGi.Scripting\DiGi.Scripting.Python`)
* **[DiGi.Scripting](DiGi.Scripting)** (Path: `DiGi.Scripting\DiGi.Scripting`)
